...
def main():
    ...
    pall.add_argument('--solver-lp', choices=['glpk','glpk_exact','scipy','gurobi','cplex','hybrid'], default='glpk', help='LP solver for FBA (sink_milp). gurobi/cplex require licenses. hybrid uses HiGHS (cobrapy>=0.29).')
