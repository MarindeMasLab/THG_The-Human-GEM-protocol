...
if __name__ == '__main__':
    import argparse
    parser = argparse.ArgumentParser(description='Greedy Phase-3 deadend optimizer')
    ...
    parser.add_argument('--solver-lp', choices=['glpk','glpk_exact','scipy','gurobi','cplex','hybrid','highs'], default=None, help='LP solver for any FBA checks')
    ...
    if not os.path.exists(cand_csv):
        ...
        out_csv, model_out, n = run_phase3(cand_csv, starting_model_json=args.model, out_dir=args.out)
